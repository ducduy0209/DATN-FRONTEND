      ...
      <footer className="bg-theme footer border-t-2 border-white px-40 py-10 text-black">
        ...
        <nav>
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="cursor-pointer hover:text-green-400">Hướng dẫn kiểm tra tem sách</p>
            <p className="cursor-pointer hover:text-green-400">Hướng dẫn sử dụng sách ebook</p>
          </div>
        </nav>
      </footer>
      <div className="flex justify-center bg-green-400 py-1 text-white">
        Copyright © 2024 - MERCHIZE BOOK STORE. All rights reserved.
      </div>
    </>
  )
}
